...
export const ATLAS_UI: Record<Locale, AtlasUiCopy> = {
  ko: {
    ...
    releaseSummary: "KR · JP · TW · US",
    releaseScope:
      "4개국을 한 화면에서 함께 엽니다. 시설·선형망은 출처가 검증된 대표 레코드부터 공개하며, 전국 완전목록으로 해석하면 안 됩니다.",
    mapTitle: "산업·에너지 인프라 통합 지도",
    mapIntro:
      "레이어를 조합하고 시설을 선택해 운영사·소유주·공개된 연결 관계와 상장사를 확인하세요.",
    mapAria: "대한민국, 일본, 대만, 미국의 공개 인프라 지도",
    layers: {
      power_plant: "발전소",
      data_center: "데이터센터",
      network_hub: "네트워크 허브",
    ...
    countryMethodWarning:
      "한국·일본·대만·미국의 지표는 시간단위와 모집단이 서로 다릅니다. 국가 간 수치를 직접 순위화하지 않습니다.",
    provenanceTitle: "출처·범위·업데이트",
    provenanceIntro:
      "시설과 기업 관계는 1차 공개자료, 선형 인프라는 별도 보관한 OSM 공개 스냅샷을 사용합니다.",
    coverage: "공개 범위",
    retrieved: "수집",
    currentRelease: "4개국 동시 공개",
  ...
  en: {
    allCountries: "All four countries",
    publicSnapshot: "Representative public snapshot",
    releaseSummary: "KR · JP · TW · US",
    releaseScope:
      "All four countries are open in one view. Facilities and networks begin with source-verified representative records and are not a nationwide complete inventory.",
    ...
    mapAria: "Public infrastructure map of South Korea, Japan, Taiwan, and the United States",
    layers: {
    ...
    countryMethodWarning:
      "Time scales and populations differ across the four countries. Values must not be ranked directly across countries.",
    ...
    coverage: "Coverage",
    retrieved: "Retrieved",
    currentRelease: "Four-country release",
    ...
    allOverview: "Four-country overview",
    zoomIn: "Zoom in",
    zoomOut: "Zoom out",
    resetView: "Reset map",
  },
  "zh-CN": {
    ...
    releaseSummary: "KR · JP · TW · US",
    releaseScope:
      "韩国、日本、台湾与美国在同一界面开放。设施与网络从经来源核验的代表性记录开始，并非全国完整清单。",
    mapTitle: "产业与能源基础设施综合地图",
    mapIntro: "组合图层并选择设施，查看运营商、所有者、公开连接关系及关联上市公司。",
    mapAria: "韩国、日本、台湾和美国的公共基础设施地图",
    layers: {
      power_plant: "发电厂",
      data_center: "数据中心",
      network_hub: "网络枢纽",
  ...
  ja: {
    ...
    releaseSummary: "KR · JP · TW · US",
    releaseScope:
      "韓国・日本・台湾・米国を同じ画面で公開します。施設とネットワークは出典検証済みの代表レコードから始まり、全国の完全な台帳ではありません。",
    mapTitle: "産業・エネルギーインフラ統合地図",
    mapIntro:
      "レイヤーを組み合わせ、施設を選択して運営者・所有者・公開された接続関係・関連上場企業を確認できます。",
    mapAria: "韓国、日本、台湾、米国の公開インフラ地図",
    layers: {
      power_plant: "発電所",
      data_center: "データセンター",
